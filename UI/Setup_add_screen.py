...
# Frame tải file
    ...
    browse_button = ttk.Button(
        constants.file_frame,
        text="Duyệt...",
        command=event_handling.browse_file
    )
...
# Nút Thêm dự án
    add_button = ttk.Button(
        constants.add_frame,
        text="Thêm Dự án",
        command=event_handling.handle_add_project
    )
    add_button. pack( pady = 10)
    
# Gọi toggle_input_method ban đầu để hiển thị đúng frame
    event_handling.toggle_input_method()
